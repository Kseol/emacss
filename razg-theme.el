...
(custom-theme-set-faces
 'razg
 '(default ((t (:family "Ubuntu Mono" :foundry "unknown" :width normal :height 128 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "gray80" :background "#181a26" :stipple nil :inherit nil))))
